...
DROP FUNCTION IF EXISTS `jmlPenghasilan`;;
CREATE FUNCTION `jmlPenghasilan`(`tanggal_awal` DATETIME, `tanggal_akhir` DATETIME) RETURNS int(11)
BEGIN 
...
DROP FUNCTION IF EXISTS `jmlStatusTanggal`;;
CREATE FUNCTION `jmlStatusTanggal`(`st` ENUM('proses','dicuci','siap diambil','sudah diambil'), `tgl` DATE) RETURNS int(11)
    NO SQL
BEGIN
DECLARE jmlHasil INT;
...
DROP FUNCTION IF EXISTS `jmlTransPaket`;;
CREATE FUNCTION `jmlTransPaket`(`idPaket` INT) RETURNS int(11)
BEGIN
DECLARE jmlHasil INT;
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `user_ibfk_3` FOREIGN KEY (`id_outlet`) REFERENCES `outlet` (`id_outlet`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1,	'Marita Dwi',	'Blora',	'2002-06-16',	'wanita',	'a',	'081222333454',	'maritadwi@gmail.com',	'Jl. Perjuangan, Gg. Melati II, Kecamatan Pati, Kabupaten Pati, Provinsi Jawa Tengah.',	'pas.png',	1),
(2,	'Abdulah Gofur',	'Semarang',	'2002-07-17',	'pria',	'ab',	'012853132222',	'gofur@gmail.com',	'Jl. perjuangan',	'pas_boy1.png',	2),
(3,	'Muhammad Agung',	'Jakarta',	'2002-08-28',	'pria',	'',	'081234567890',	'irgi@gmail.com',	'Perum Puri Serpong 1 Blok D5',	'pas_boy2.png',	3),
...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`id_log`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `log_ibfk_2` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1060,	'Pengguna super_administrator berhasil login',	'2022-09-08 15:54:05',	1),
(1061,	'Biodata Pengguna super_administrator berhasil diubah',	'2022-09-08 16:02:37',	1),
(1062,	'Print profile',	'2022-09-08 16:09:29',	1),
(1063,	'Member Silvani Violita berhasil ditambahkan',	'2022-09-08 16:18:36',	1),
(1064,	'Pengguna admin berhasil ditambahkan',	'2022-09-08 16:23:00',	1),
(1065,	'Biodata Pengguna Abdul Haris berhasil ditambahkan',	'2022-09-08 16:24:09',	1),
(1066,	'Biodata Pengguna super_administrator berhasil diubah',	'2022-09-08 16:25:54',	1),
(1067,	'Biodata Pengguna super_administrator berhasil diubah',	'2022-09-08 16:26:44',	1),
(1068,	'Pengguna kasir berhasil ditambahkan',	'2022-09-08 16:28:09',	1),
(1069,	'Biodata Pengguna Putri Yulia berhasil ditambahkan',	'2022-09-08 16:29:05',	1),
(1070,	'Pengguna owner berhasil ditambahkan',	'2022-09-08 16:30:35',	1),
(1071,	'Biodata Pengguna Inten Erviatun berhasil ditambahkan',	'2022-09-08 16:31:38',	1),
(1072,	'Cetak Laporan - 2022-01-01 00:00:00 - 2022-09-08 23:59:59',	'2022-09-08 16:34:53',	1),
(1073,	'Pengguna super_administrator berhasil logout',	'2022-09-08 16:35:23',	1),
(1074,	'Pengguna admin berhasil login',	'2022-09-08 16:35:29',	9),
(1075,	'Pengguna admin berhasil logout',	'2022-09-08 16:37:31',	9),
(1076,	'Pengguna kasir berhasil login',	'2022-09-08 16:37:37',	10),
(1077,	'Pengguna kasir berhasil logout',	'2022-09-08 16:40:58',	10),
(1078,	'Pengguna super_administrator berhasil login',	'2022-09-08 16:58:16',	1),
(1079,	'Pengguna super_administrator berhasil login',	'2022-12-27 14:44:44',	1),
(1080,	'Pengguna super_administrator berhasil login',	'2022-12-29 17:31:01',	1),
(1081,	'Cetak Invoice - 120320202515T0005 - Himdan Al Ghozan',	'2022-12-29 17:35:58',	1),
(1082,	'Pengguna super_administrator berhasil login',	'2022-12-30 12:06:21',	1),
(1083,	'Cetak Laporan - 2022-12-01 00:00:00 - 2022-12-30 23:59:59',	'2022-12-30 12:31:27',	1),
(1084,	'Cetak Laporan - 2019-01-01 00:00:00 - 2022-12-30 23:59:59',	'2022-12-30 12:31:49',	1),
(1085,	'Cetak Laporan - 2021-01-01 00:00:00 - 2022-12-30 23:59:59',	'2022-12-30 12:32:21',	1),
(1086,	'Cetak Invoice - 17032020123T0001 - Bintang Shakila Akassah',	'2022-12-30 12:33:56',	1),
(1087,	'Cetak Invoice - 17032020123T0001 - Bintang Shakila Akassah',	'2022-12-30 12:34:40',	1);
...
(19,	'Silvani Violita',	'wanita',	'082333444565',	'violita@gmail.com',	'Desa Sambiroto');
...
CREATE TABLE `pembayaran` (
  ...
  CONSTRAINT `pembayaran_ibfk_3` FOREIGN KEY (`id_transaksi`) REFERENCES `transaksi` (`id_transaksi`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
